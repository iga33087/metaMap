  ...
  <div class="home" v-if="weatherElement">
    ...
    <div class="homeBox">
      <div class="homeBoxCol">
        <HomeBoxColItem title="Wx(天氣現象)" :icon="getIcon(weatherElement.records.location[getFocusIndex].weatherElement[0].time[time].parameter.parameterValue)" :content="weatherElement.records.location[getFocusIndex].weatherElement[0].time[time].parameter.parameterName"></HomeBoxColItem>
        <HomeBoxColItem title="PoP(降雨機率)" :content="weatherElement.records.location[getFocusIndex].weatherElement[1].time[time].parameter.parameterName+'%'"></HomeBoxColItem>
        <HomeBoxColItem title="CI(舒適度)" :content="weatherElement.records.location[getFocusIndex].weatherElement[3].time[time].parameter.parameterName"></HomeBoxColItem>
        <HomeBoxColItem title="MinT(最低溫度)" :content="weatherElement.records.location[getFocusIndex].weatherElement[2].time[time].parameter.parameterName+'°C'"></HomeBoxColItem>
        <HomeBoxColItem title="MaxT(最高溫度)" :content="weatherElement.records.location[getFocusIndex].weatherElement[4].time[time].parameter.parameterName+'°C'"></HomeBoxColItem>
      </div>
      <Map :time="time" :mapMode="mapMode" :weatherElement="weatherElement" :iconPoint="iconPointAndIcon" @getFocus="getFocus">
        <div class="mapMode">
